...
const menuItems = [
  ...
  //   { label: `NAV_LABEL_USER_AREA`, url: `/user_area/messages` },
  //   { label: `NAV_LABEL_USER_AREA`, url: `/user_area/reviews` },
  //   { label: `NAV_LABEL_USER_AREA`, url: `/user_area/settings` }
];
    ...
    <header className="flex flex-col">
      ...
      <div className="flex flex-row px-5 md:px-12 mb-5">
        <div className="flex self-end w-40 md:w-200">
          <Link href="/">
            <Image width={200} height={0} src="/logo.png" alt="logo" />
          </Link>
        </div>
